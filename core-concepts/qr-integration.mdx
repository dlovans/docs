...
<Info>
**No webhooks needed for Identify and Sign.** The polling flow is the primary integration pattern. Webhooks are only used for the Message API.
</Info>
...
<Steps>
  <Step title="Use Your $20 Signup Credit">
    New accounts receive $20 in credits on their first business — plenty for extensive testing
  </Step>
