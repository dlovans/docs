...
description: "GET /.well-known/uip-audit-jwks.json"
---
...
`uip_signature` is a detached audit field, not a JWS object. Its `value` is a
  ...
  "keys": [
    {
      ...
      "alg": "ES256",
      "use": "sig",
      "kid": "projects/uip/locations/global/keyRings/audit/cryptoKeys/sign/cryptoKeyVersions/3",
      "x": "...",
      "y": "..."
    }
  ]
