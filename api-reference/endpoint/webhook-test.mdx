...
def webhook():
    ...
    if event == 'test':
        print(f"Test webhook received: {event_data.get('pong')}")
        return 'OK', 200
...
func webhookHandler(w http.ResponseWriter, r *http.Request) {
    ...
    if payload.Event == "test" {
        println("Test webhook received:", payload.Data["pong"])
...
<CardGroup cols={2}>
  <Card title="Webhooks Guide" icon="webhook" href="/core-concepts/webhooks">
