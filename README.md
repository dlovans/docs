# Alentra Documentation

API documentation for the **Alentra** -- government-attested identity primitives verified from the user's own digital wallet through a canonical country/credential/provider route.

**Live Docs:** [docs.alentra.app](https://docs.alentra.app)
...
> provider/issuer access, trust material, acceptance, and Alentra production approval.

---

## What is Alentra?

Alentra is a developer platform exposing government-attested identity primitives verified from the user's own digital wallet. Each session pins one country, credential profile, and presentation provider. Alentra builds the request, verifies the wallet's signed response against that profile's trust anchors, and delivers results via signed webhook.
...
- **Evidence-oriented signatures** — device-signed content with a reproducible audit hash, public Alentra signature, and wallet verification material
...
- [Quickstart](https://docs.alentra.app/quickstart) -- Create a session and receive a result
- [API Reference](https://docs.alentra.app/api-reference/introduction) -- Complete API docs
- [Pricing](https://docs.alentra.app/pricing) -- Usage-based pricing
- [Open Alentra](https://alentra.app) — create a business, select Coverage, fund its wallet, and mint a key
